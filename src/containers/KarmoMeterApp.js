...
export default class KarmoMeter extends Component {
  ...
  componentDidMount(){
    ...
    console.log('this.gauge: ', this.gauge);
  }
...
function loadLiquidFillGauge(elementId, value, config) {
    ...
    if(config.valueCountUp){
        var textTween = function(){
            var i = d3.interpolate(d3.select('#fillgauge').text(), textFinalValue);

            return function(t) {
              var newText = textRounder(i(t)) + percentText
              d3.select('#fillgauge').text(newText);
            }
        };
        text1.transition()
    ...
    function GaugeUpdater(){
        this.update = function(value){
            ...
            var textTween = function(){
                var i = d3.interpolate(d3.select('#fillgauge').text(), parseFloat(value).toFixed(2));
                return function(t) {
                  var newText = textRounder(i(t)) + percentText
                  d3.select('#fillgauge').text(newText);
                }
